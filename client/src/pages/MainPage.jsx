...
export default function TheoProfile() {
            ...
            <div className="container mx-auto px-4">
              <div className="relative h-20 rounded-b flex justify-center">
                <div className="absolute -bottom-6">
                  {/* Sua foto aqui: */}
                    <img
                      src="https://i.imgur.com/EDoL61t.jpg"
              ...
              <div className="mt-10 py-10 border-t border-blueGray-200 text-center">
                <div className="flex flex-wrap justify-center">
                  <div className="w-full lg:w-9/12 px-4">                           
                    ...
                    Meu nome é Théo Corvello Soares, tenho 19 anos e nasci no dia 11/09/2004 na cidade de São Lourenço do Sul e gosto de jogar cs e xingar boludos (no cs obviamente)
                    </p>
                    <br/>
                    {/* Link para seu GitHub aqui: */}
                    <a href="https://github.com/Thelvz/git-minicurso-saicc" className="font-normal text-yellow-500">
                      <GitHubIcon/>
                    </a>
                  </div>
                </div>
